...
public interface VfsSource
{
     ...
     * @return Boolean, true if the VfsSource is a directory and false otherwise. 
     */
     ...
     * <p>
     * @param globExpr object, that represent the regular expression for make the quest.
     * @param path The path attribute
     * @return List<Path>, return List of Path object that result of the quest. 
     */
