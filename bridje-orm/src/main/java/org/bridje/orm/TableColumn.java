...
public interface TableColumn<E, T> extends Column<T>
{
    ...
    /**
     * If this column is an integer base type and is the primary key for the
     * table it can be autoincrement.
     *
    ...
    /**
     * Determines when ever this column is required.
     *
     * @return true the column is required, therefore it cannot be null, false
     *         otherwise.
     */
    boolean isRequired();
