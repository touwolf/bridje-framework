...
/**
 * Annotations processor for the {@link javax.websocket.server.ServerEndpoint} annotation.
 */
@SupportedAnnotationTypes("javax.websocket.server.ServerEndpoint")
...
public class WebSocketProcessor extends AbstractProcessor
{
    ...
    private static final Logger LOG = Logger.getLogger(WebSocketProcessor.class.getName());

    public static final String RESOURCE_FILE = "BRIDJE-INF/web/websocket-server-endpoints";
    ...
    public synchronized void init(ProcessingEnvironment processingEnv)
    {
        ...
        try
        {
            ...
            fobj = filer.createResource(StandardLocation.CLASS_OUTPUT, "", RESOURCE_FILE);
            ...
            for (TypeElement typeElement : annotations)
            {
                ...
                for (Element element : ann)
                {
                    if (element.getKind() == ElementKind.CLASS)
                    {
                        ...
                        ServerEndpoint annot = element.getAnnotation(ServerEndpoint.class);
                        if(annot != null)
                        {
     ...
     */
    private void appendClass(String clsName) throws IOException
    {
