...
public abstract class ${model.name}Base
{
    ...
    protected void doSave${entity.name}(${entity.name} entity) throws SQLException
    {
        ...
        {
            env.update(${entity.name}.UPDATE_QUERY, <#list entity.nonAiFields as field><#if field.needCustomGetter>get${entity.name}${field.name?cap_first}(entity)<#else>entity.get${field.name?cap_first}()</#if><#sep>, </#sep></#list>, entity.get${entity.key.name?cap_first}());
        }
    }
